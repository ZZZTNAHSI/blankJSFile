...
function App() {
  ...
  const {isFetching, error, fetchedData: userPlaces, setFetchData: setUserPlaces} = useFetch(fetchUserPlaces, []);
  ...
  return (
    <>
    <Modal open={errorUpdatingPlaces} onConfirm={handleError} onClose={handleError}>
