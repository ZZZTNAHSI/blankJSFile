...
function signupAction(prevState ,formData) {
  ...
  const actuisitionChannel = formData.getAll("acquisition");
  ...
  if (actuisitionChannel.length === 0) {
      ...
      <fieldset>
        ...
        <div className="control">
          <input
            ...
            name="acquisition"
            value="google"
            defaultChecked={formState.enteredValues?.actuisitionChannel.includes("google")}
          />
        ...
        <div className="control">
          <input
            ...
            name="acquisition"
            value="friend"
            defaultChecked={formState.enteredValues?.actuisitionChannel.includes("friend")}
          />
          <label htmlFor="friend">Referred by friend</label>
        </div>

        <div className="control">
          <input type="checkbox" id="other" name="acquisition" value="other" defaultChecked={formState.enteredValues?.actuisitionChannel.includes("other")}/>
